...
export default function PnLTable({ data = [], onRowClick, priceFlashMap = {} }) {
      ...
      <Table sx={{ minWidth: 650 }}>
        <TableHead sx={{ backgroundColor: 'action.hover' }}>
          <TableRow>
            ...
            <TableCell align="right"><strong>Live / Close Price</strong></TableCell>
        ...
        <TableBody>
          {data.map((row) => {
            const flashClass = priceFlashMap[row.securityId] || '';
